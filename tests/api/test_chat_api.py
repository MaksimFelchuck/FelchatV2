...
class TestChatAPI:
    ...
    def test_chat_page_authenticated(self, client: TestClient):
        ...
        cookies = create_and_login_user(client, "chatuser", "chat@example.com", "password123")
    ...
    def test_chat_page_with_blocked_user(self, client: TestClient):
        ...
        cookies1 = create_and_login_user(client, "blocker", "blocker@example.com", "password123")
        cookies2 = create_and_login_user(client, "blocked", "blocked@example.com", "password123")
    ...
    def test_chat_websocket_endpoint(self, client: TestClient):
        ...
        # First login to get cookies
        cookies = create_and_login_user(client, "wsuser", "ws@example.com", "password123")
